...
const TYPES = ['hentai', 'hanal', 'tentacle', 'paizuri', 'hboobs'];
...
module.exports = async (sock, chatId, message, args) => {
    try {
        ...
        console.error('unhentai error:', error.message);
        await sock.sendMessage(chatId, { text: '❌ Failed to fetch unhentai.' }, { quoted: message });
    }
};
