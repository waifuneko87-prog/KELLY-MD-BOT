...
const TYPES = ['hentai', 'hneko', 'hkitsune', 'paizuri', 'hboobs', 'hanal'];
...
module.exports = async (sock, chatId, message) => {
    try {
        ...
        console.error('candy error:', error.message);
        await sock.sendMessage(chatId, { text: '❌ Failed to fetch candy.' }, { quoted: message });
    }
};
