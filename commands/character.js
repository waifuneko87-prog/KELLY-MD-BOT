...
const { enforceMiscPermission } = require('../lib/miscPermission');
...
async function characterCommand(sock, chatId, message) {
    ...
    // .character also displays the target's full profile picture publicly,
    // so it gets the same sudo/owner + admin protection as misc commands.
    if (!(await enforceMiscPermission(sock, chatId, message, userToAnalyze))) return;
